...
//             <h3 className="text-gray-500 mb-2">Courses in Progress</h3>
//             <p className="text-3xl font-bold">4</p>
//           </div>
//           <div className="bg-white p-6 rounded-lg shadow-sm">
//             <h3 className="text-gray-500 mb-2">Completed Courses</h3>
//             <p className="text-3xl font-bold">12</p>
//           </div>
//           <div className="bg-white p-6 rounded-lg shadow-sm">
//             <h3 className="text-gray-500 mb-2">Certificates Earned</h3>
...
//       <div className={`transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'} p-8`}>
//         {/* Header */}
//         <header className="flex items-center justify-between mb-8">
//           <div>
//             <h1 className="text-3xl font-extrabold text-gray-800">Dashboard</h1>
      ...
      <div className={`transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'} p-8`}>
        ...
        <header className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4 relative">
            ...
            >
              <FiUser className="w-6 h-6 text-gray-600" /> {/* Replaced FiBell with FiUser */}
              <span className="absolute top-0 right-0 w-2.5 h-2.5 bg-red-500 rounded-full ring-2 ring-white"></span>
            </button>
